...
export const messageGroups: MessageGroup[] = [
  ...
  },
  {
    ...
    members: ['current-user', 'liisa-makinen', 'maria-lahtinen', 'juha-nieminen'],
    isPrivate: true
  }
]
...
export const messages: Message[] = [
  {
    ...
    content: 'Hi! Did you see the city centre development plan thread? I think we should coordinate our cycling club response.',
  ...
  },
  {
    ...
    content: 'Yes, I read through it. The cycling infrastructure section looks promising. Should we draft something together?',
  ...
  },
  {
    ...
    content: 'Reminder: Our next board meeting is Thursday at 18:00. Main topic is the facade renovation budget.',
  ...
  },
  {
    ...
    content: 'Who\'s coming to Sunday dinner? Mom wants to know how much to cook.',
    createdAt: '2025-01-21T11:00:00Z',
    isEncrypted: true
  }
]

export const getMessagesByConversation = (userId1: string, userId2: string): Message[] => {
...
export const getConversations = (userId: string): { partnerId: string; lastMessage: Message }[] => {
