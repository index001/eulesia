...
export const clubs: Club[] = [
  {
    ...
    description: 'A community for those interested in the rich industrial and cultural history of Tampere. Share old photos, discuss historical events, and explore the heritage of our city together.',
    rules: [
  ...
  },
  {
    ...
    description: 'For cyclists of all levels in the Tampere region. Share routes, discuss infrastructure, organize group rides, and advocate for better cycling conditions.',
    rules: [
  ...
  },
  {
    ...
    description: 'The community hub for Hervanta residents. Share local news, organize events, help neighbors, and discuss everything related to life in Hervanta.',
    rules: [
  ...
  },
  {
    ...
    description: 'Capturing the beauty of Finland through photography. Share your landscape photos, discuss techniques, and discover new locations across the country.',
    rules: [
  ...
  },
  {
    ...
    description: 'For balcony gardeners, community garden enthusiasts, and anyone interested in growing food and plants in urban environments across Finland.',
    rules: [
  ...
  },
  {
    ...
    description: 'Find gaming partners, organize game nights, discuss your favorite games, and discover new ones. All types of tabletop gaming welcome.',
    rules: [
